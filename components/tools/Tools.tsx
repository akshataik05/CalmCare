...
import MindfulTap from './minigames/MindfulTap';
import Sudoku from './minigames/Sudoku';
import MiniCrosswords from './minigames/MiniCrosswords';
import RiddleMeThis from './minigames/RiddleMeThis';
...
import CalmTales from './CalmTales';
...
const Tools: React.FC<ToolsProps> = ({ stressDataHook }) => {
    ...
    const renderContent = () => {
        switch (view) {
            case 'mood_booster':
                return <MoodBooster onBack={handleBack} stressDataHook={stressDataHook} />;
            case 'reframing':
                return <CognitiveReframing onBack={handleBack} stressDataHook={stressDataHook} />;
            case 'emotion_wheel':
            ...
            case 'tale_library':
                return <CalmTales onBack={handleBack} stressDataHook={stressDataHook} />;
            case 'mindful_tap':
